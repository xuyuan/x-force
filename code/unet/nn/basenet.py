...
MODEL_URLS = {
    'resnet50': {#'voc':  MODEL_ZOO_URL + 'SSDretina_resnet50_c21-fb6036d1.pth',  # SSDretina_resnet50_c81-a584ead7.pth pretrained
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained', default=False, type=str, choices=('imagenet', 'voc', 'coco', 'oid'), help='pretrained dataset')
